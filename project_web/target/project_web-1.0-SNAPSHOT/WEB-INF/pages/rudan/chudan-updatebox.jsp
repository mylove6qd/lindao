...
<%--                                {{entityList[0].inw}}-{{entityList[0].inx}}-{{entityList[0].iny}}-{{entityList[0].inz}}--%>
                    ...
                    <form id="rucang" action="${ctx}/rudan/chucang/adddate.do" method="post">
                    <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                        ...
                        <tr>
                            ...
                            <th class="sorting">出仓重量</th>
                            <th class="sorting">出仓长</th>
                            <th class="sorting">出仓宽</th>
                            <th class="sorting">出仓高</th>
                        ...
                        <c:forEach items="${list}" var="item" varStatus="a">
                            <tr>
                                ...
                                <td><input type="number" class="w" name="outhomeWeight" required value="${item.inhomeWeight}"></td>
                                <td><input type="number" class="x" name="outhomeX" required value="${item.inhomeX}"></td>
                                <td><input type="number" class="y" name="outhomeY" required value="${item.inhomeY}"></td>
                                <td><input type="number" class="z" name="outhomeZ" required value="${item.inhomeZ}"></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
