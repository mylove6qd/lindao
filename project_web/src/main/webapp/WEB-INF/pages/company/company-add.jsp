...
<%--                        value="${company.name} 设置默认值--%>
                        <input type="text" class="form-control" required placeholder="企业名称" name="companyName" >
                    </div>
...
<%--                    </div>--%>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" required placeholder="企业地址" name="companyAdress" >
                    </div>
...
<%--                    </div>--%>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" required placeholder="联系电话" name="companyPhone" pattern="^1([3-5]|[7-8])\d{9}$" oninvalid="setCustomValidity('不是电话号码')" oninput="setCustomValidity('')" >
                    </div>
...
<%--                    </div>--%>
                    <div class="col-md-2 title">公司类型*</div>
                    <div class="col-md-4 data">
                        <select class="form-control select2" name="companyType" style="width: 100%;">
                            <option value="客户公司" selected>客户公司</option>
                            <option value="渠道公司" }>渠道公司</option>
                            <option value="同行公司" }>同行公司</option>
...
<%--                        <input type="text" class="form-control" placeholder="状态" name="state" value="${company.state}">--%>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" required placeholder="公司邮箱" name="email" >
                    </div>
